...
/*
April 2024 - Mike Richards - G4WNC - Amended lines 512-3 to work with LiquidCrystal I2C
library v1.1.2 by Frank de Brabander
...
#if defined(I2C_LCD)
  LiquidCrystal_I2C lcd(0x27,20,4); // supports library by Frank de Brabander v 1.1.2
...
else
{
  */
	...
	lcd.print(" WA5BDU V1.14"); // V1.2 9/4/2020 V1.5 1/11/2021 v1.6 3/18/2022
